...
func main() {
	...
	expRepo := repository.NewExperiments(db)
	...
	r.Route("/api", func(r chi.Router) {
		...
		r.Get("/experiments/{expId}/file-pairs/{id}", handler.FilePair(expRepo))
		r.Put("/experiments/{expId}/assignments/{id}", handler.UpdateAssignment(expRepo))
		r.Get("/experiments/{id}/assignments", handler.Assignments(expRepo))
		r.Get("/experiments/{id}", handler.Experiment(expRepo))
	})
